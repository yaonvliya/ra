...
Vue.directive('dialogDrag', {
    bind(el, binding, vnode, oldVnode) {
        ...
        //获取弹框内容部
        let dialogBodyEl = el.querySelector('.el-dialog__body');
        //弹窗
        ...
        dragDom.onmousemove = function (e) {
            ...
            dragDom.onmousedown = (e) => {
                ...
                let bodyW = dialogBodyEl.clientWidth;
                let bodyH = dialogBodyEl.clientHeight;
                        ...
                        if (ELscrollTop + clientY > EloffsetTop + elH - 20 && ELscrollTop + clientY < EloffsetTop + elH) {
                            ...
                            if (clientY > e.clientY) {
                                if (dragDom.clientHeight < minHeight) {
                                    ...
                                    dialogBodyEl.style.height = bodyH - (clientY - e.clientY)-10 + 'px';
                                }
                            }
                            //往下拖拽
                            if (clientY < e.clientY) {
                                ...
                                dialogBodyEl.style.height = bodyH + (e.clientY - clientY)-10 + 'px';
                            }
                        }
                    };
                    //拉伸结束
